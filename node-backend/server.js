    ...
    try {
      const response = await fetch(`${SERVER_URL}/analyze`, {
        ...
        body: JSON.stringify({
          ...
          topic: topicKey,
          debater_name: message.debaterName
        }),
      });
